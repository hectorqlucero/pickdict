...
if [ -z "$CLOJARS_USERNAME" ]; then
    ...
    echo "export CLOJARS_USERNAME=hectorqlucero"
...
if lein deploy clojars; then
    ...
    echo "   Group ID: hectorqlucero"
    echo "   Artifact ID: pickdict"
    echo "   Version: 0.1.0"
    echo ""
    echo "📦 Installation for users:"
    echo "   [hectorqlucero/pickdict \"0.1.0\"]"
    echo ""
    echo "🔗 Clojars URL: https://clojars.org/hectorqlucero/pickdict"
